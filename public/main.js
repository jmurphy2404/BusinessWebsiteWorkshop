document.addEventListener("DOMContentLoaded", function(){
    ...
    document.getElementById("s").addEventListener("click", function(){
        document.getElementById("ninteen").style.visibility = "visible";
    })
   ...
   // document.querySelectorAll("h3").addEventListener("click", function(){
     //   document.querySelectorAll(".description").style.visibility = "hidden";
 //   })
})